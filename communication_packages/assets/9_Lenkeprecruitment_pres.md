...
# СТРУКТУРА ПРЕЗЕНТАЦИИ ДЛЯ Lenkep recruitment

Слайд 1: Титульный
- Заголовок: Кадровый резерв для Lenkep recruitment
...
- Команда студентов уже знает JavaScript.
- Они делают ваши задачи из бэклога в рамках учебы.

Слайд 4: Выгода для Lenkep recruitment
